...
;
export class XtalStateMerge extends XtalStateCommit {
    static get is() { return 'xtal-state-merge'; }
    ...
    preProcess(stateUpdate) {
        ...
        XtalStateMerge._lastPath = this._wherePath;
...
//# sourceMappingURL=xtal-state-merge.js.map